...
urlpatterns = [
    ...
    path('add_to_favourite_restaurants/', api.addToFavouriteRestaurants),
    path('remove_from_favourite_restaurants/', api.removeFromFavouriteRestaurants),
    path('favourite_restaurants/', api.getFavouriteRestaurants),
